...
[assembly: Xamarin.Forms.Dependency(typeof(Dystir.ViewModels.DystirViewModel))]
namespace Dystir.ViewModels
{
    public class DystirViewModel : BaseViewModel
    {
        ...
        private async Task GetMatchDetailsAsync(Match selectedMatch)
        {
            ...
            {
                MatchDetails selectedMatchDetails = AllMatches?.FirstOrDefault(x => x.MatchID == selectedMatch?.MatchID).Details;
        ...
        public void SetAllMatchesWithDetails()
        {
            ...
            {
                MatchDetails matchDetails = AllMatches.FirstOrDefault(x => x.MatchID == match.MatchID).Details;
                if (matchDetails != null)
                {
