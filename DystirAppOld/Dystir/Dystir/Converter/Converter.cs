...
namespace Dystir.Converter
{
    ...
    public class PlayersPositionLanguageConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            if (value != null && (value as PlayerOfMatch).PlayerOfMatchID > 0)
            {
                ...
                {
                    return Properties.Resources.ResourceManager.GetString((position ?? "").ToString(), culture);
                }
                else
                {
                    return "---";
    ...
    public class ToSelectedColorConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            return value != null && (int)value == int.Parse(parameter.ToString()) ? Color.FromHex("#2F4F2F") : Color.DimGray;
        }
    ...
    public class MachesSelectedColorConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            return value != null && (bool)value == true ? Color.FromHex("#2F4F2F") : Color.DimGray;
        }
